      ...
      state.snapshot.clues.forEach((clueInput, idx) => {
        ...
        try {
          ...
          if (translation.constraints.length > 0) {
            ...
            constraintSection.setAttribute("data-solver-ui", "true");
            ...
            header.setAttribute("data-solver-ui", "true");
  ...
  function attachObserver() {
    ...
    observer = new MutationObserver((mutations) => {
      const relevantMutation = mutations.some((m) => {
        ...
        if (target.hasAttribute?.("data-solver-ui") || target.closest?.("[data-solver-ui]") || target.id === OVERLAY_ID || target.id === "solver-stats-panel" || target.id === "solver-rules-panel" || target.closest("#" + OVERLAY_ID) || target.closest("#solver-stats-panel") || target.closest("#solver-rules-panel")) {
          return false;
        }
        return true;
      });
